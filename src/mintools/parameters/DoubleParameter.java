...
public class DoubleParameter extends BoundedParameter<Double> implements PropertyChangeListener, ChangeListener {
    ...
    /** set to false if slider controls are unwanted (e.g., no bounds) */
    private boolean useSliderControl = true;
     ...
     *        the maximum value of this parameter
     */
    public DoubleParameter(String name, double defaultValue, double minValue, double maxValue, boolean isLog) {        
